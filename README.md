...
---
إليك البيانات المطلوبة لرفع تفاصيل المنتج لكل فئة مع توضيح المعلومات المشتركة بين جميع الفئات، وكذلك المعلومات الخاصة بكل فئة:

---

### **البيانات المشتركة لجميع الفئات:**
1. **الاسم**: اسم المنتج.
2. **الوصف**: وصف تفصيلي لاستخدام المنتج وميزاته. ( سوف تحدد تلقائى بناء على ما يختار المستخدم رفع منتج من فائمة معينة )
3. **السعر اليومي/الأسبوعي/الشهري**: تحديد أسعار التأجير حسب الفترات.
4. **الحالة**: جديد/مستخدم.
5. **الصور**: صور واضحة للمنتج من زوايا مختلفة.


---

### **الفئات وتفاصيل البيانات المختلفة**

#### **1. الأدوات والمعدات الرياضية**
- **المقاسات**: مثل وزن الأثقال أو حجم المعدات (إذا كان مناسبًا).
- **الفئة الرياضية**: نوع النشاط الرياضي (مثل اللياقة البدنية، الغوص، التزلج).

#### **2. أدوات السفر والتخييم**
- **الأبعاد والوزن**: مثل حجم الخيمة أو وزن حقيبة السفر.
- **مزايا إضافية**: مثل العزل المائي أو المتانة (اختياري).

#### **3. وسائل النقل**
- **الموديل وسنة الصنع**: تحديد الموديل وسنة الصنع للمركبة.
- **عداد المسافة**: المسافة التي قطعتها المركبة (إذا كانت مناسبة).
- **سعة المحرك**: للسيارات والدراجات النارية.

#### **4. الأجهزة الإلكترونية**
- **المواصفات الفنية**: مثل نوع المعالج، الذاكرة، دقة الشاشة.
- **عمر البطارية**: إذا كان الجهاز يعمل ببطارية (مثل الكاميرات المحمولة).
